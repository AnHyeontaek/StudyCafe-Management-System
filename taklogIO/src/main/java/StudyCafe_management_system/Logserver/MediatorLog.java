...
import StudyCafe_management_system.Logclient.client;
...
public class MediatorLog  {
    ...
    public void select(int a){ //사용자의 입력에 따른 기능을 switch 문으로 실행
            ...
            case 1: 
                ...
                break;
            case 2:
                JoinMember jm = new JoinMember(); //회원가입 객체 생성
                jm.join(jm.inputid(), jm.inputpw(), jm.inputName(), jm.inputBirth());  //사용자에게 회원가입 정보를 입력받아 매개변수로 넘김
                break;
            case 3:
